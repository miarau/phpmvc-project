<?php
/**
 * Config-file for Miax, theme related settings, return it all as array.
 *
 */
return [
     ...
     */
    'views' => [
		['region' => 'adminbar', 'template' => 'univ/adminbar', 'data' => [], 'sort' => -1],
        ['region' => 'header', 'template' => 'univ/header', 'data' => [], 'sort' => -1],
        ['region' => 'footer', 'template' => 'univ/footer', 'data' => [], 'sort' => -1], 
    ...
    'data' => [
        ...
        'title_append' => ' | Allt om universum',
